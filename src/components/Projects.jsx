...
export default function Projects() {
  return (
    <div className="flex flex-col items-center gap-20 px-8 lg:gap-x-4 lg:gap-y-20 xl:grid-cols-3 lg:grid-cols-2 py-14 bg-base-200 lg:grid ">
      <div className="flex-row items-center justify-center w-full max-w-lg m-auto shadow-xl max-h-max lg:flex-col card card-compact bg-base-300">
        <div className="w-2/5 lg:w-full">
          ...
          <figure className=""><img className="rounded-l-xl lg:hidden" src="src/assets/star-wars-mobile.gif" alt="star-wars-mobile" /></figure>
        </div>
